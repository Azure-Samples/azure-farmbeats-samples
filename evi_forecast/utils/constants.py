...
CONSTANTS= {
    "farm_geojsons": "results//farms_sample_1kmx1km.csv",  # filename to save geojson sample
    ...
    "sat_file_paths": "C:\\azure-farmbeats-samples\\satellite_paths.csv",  # filePaths of tif files. Output for _1_download_fb and imput for _2_build_model
    ...
    "ref_tm_model": "01-03-2019",  # start of growing season
    "sat_res_x_model": 10,  # spatial sampling in model training, this might differ for inferance
    "interp_date_start": "01-01-2019",  # model iterpolation start date
    "interp_date_end": "30-12-2019",  # model iterpolation start date
